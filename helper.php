...
class ModAdvancedSearchHelper
{
    ...
    {
        $history = Factory::getApplication()->input->cookie->get('mod_advancedsearch_history', '[]'); // Valor predeterminado como array vacío
    ...
    public static function addSearchToHistory($params)
    {
        ...
        Factory::getApplication()->input->cookie->set('mod_advancedsearch_history', json_encode($history)); // Convertimos el array a JSON
    }
